...
const Shop = () => {
  ...
  const products = [
    { 
      ...
      category: "flour", 
      price: 2500, 
      image: "https://images.pexels.com/photos/326279/pexels-photo-326279.jpeg?auto=compress&cs=tinysrgb&w=400",
      badge: "Bestseller",
      description: "Premium quality bean flour, stone-ground for authentic taste. Perfect for moi moi and akara. Rich in protein and fiber."
    },
    { 
      id: 2, 
      name: "Yam Flour", 
      ...
      badge: null,
      description: "Finely processed yam flour for smooth, lump-free amala. Made from premium white yams, sun-dried and milled to perfection."
    },
    { 
      id: 3, 
      ...
      badge: "Premium",
      description: "Premium poundo yam flour that gives you smooth, stretchy pounded yam in minutes. No lumps, just perfect consistency every time."
    },
    { 
      id: 4, 
      name: "Fufu Flour", 
      ...
      badge: null,
      description: "Authentic fermented fufu flour. Smooth texture and traditional taste that pairs perfectly with any Nigerian soup."
    },
    { 
      id: 5, 
      name: "Oat Meal Flour", 
      category: "flour", 
      price: 3200, 
      image: "https://images.pexels.com/photos/1295752/pexels-photo-1295752.jpeg?auto=compress&cs=tinysrgb&w=400",
      badge: "Healthy",
      description: "100% whole grain oat flour, perfect for healthy baking and swallow. High in fiber and naturally gluten-friendly."
    },
    { 
      id: 6, 
      name: "Soya Flour", 
      ...
      badge: null,
      description: "Protein-rich soya bean flour, great for adding nutrition to your meals. Perfect for soya milk and baking."
    },
    { 
      id: 7, 
      name: "Ijebu Garri", 
      ...
      badge: "Bestseller",
      description: "Premium Ijebu garri with that signature sour taste. Crispy, fine grains perfect for drinking or eba."
    },
    { 
      id: 8, 
      name: "Garri Oyo", 
      category: "garri", 
      price: 1200, 
      image: "https://images.pexels.com/photos/1435909/pexels-photo-1435909.jpeg?auto=compress&cs=tinysrgb&w=400",
      badge: null,
      description: "Smooth Oyo garri with mild taste. Perfect for those who prefer less sour garri. Great for eba and drinking."
    },
    { 
      id: 9, 
      name: "Palm Oil", 
      ...
      badge: "Pure",
      description: "100% pure red palm oil, traditionally processed. Rich in Vitamin A and perfect for all Nigerian soups and stews."
    },
    { 
      id: 10, 
      ...
      category: "spice", 
      price: 800, 
      image: "https://images.pexels.com/photos/1437590/pexels-photo-1437590.jpeg?auto=compress&cs=tinysrgb&w=400",
      badge: "Spicy",
      description: "Hot and flavorful dried chili pepper powder. Perfect for adding that authentic Nigerian heat to your dishes."
    },
    { 
      id: 11, 
      ...
      badge: null,
      description: "Fermented locust beans (Iru) for that authentic umami flavor. Essential for traditional Nigerian soups."
    },
    { 
      id: 12, 
      name: "Premium Rice", 
      ...
      badge: "Premium",
      description: "Long grain premium rice, stone-free and perfectly polished. Ideal for jollof, fried rice, and white rice."
    },
  ];
  ...
  const handleBuyNow = (product) => {
    const message = `Hello, I want to buy ${product.name}%0A%0A` +
        ...
        <div className="container">
          <div className="row align-items-center">
            <div className="col-md-8 text-center text-md-start mb-3 mb-md-0">
              ...
              <p className="text-secondary mb-0">
                Perfect for events, restaurants, or stocking up. Get special pricing on large quantities.
              </p>
            </div>
